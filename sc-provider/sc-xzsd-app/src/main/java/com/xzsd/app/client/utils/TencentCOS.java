package com.xzsd.app.client.utils;
...
public class TencentCOS {
    ...
    // 此处填写的存储桶名称
    private static final String bucketName = "xzsd-1300629556";
    // secretId
    private static final String secretId = "AKIDGGP1MZxIo31pVuO8SVHmHgpkOs63lHn4";
    // secretKey
    private static final String secretKey = "ECxRebM5XqrpWvfFjw0nQmrfLVP9dx0f";
